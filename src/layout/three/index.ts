...
const buttons: NavButton[] = [
    ...
    { id: 'helix', text: 'DOUBLE HELIX', click: () => changeModeTo(helix) },
    ...
    for (let i = 0; i < users.length; i++) {
        ...
        element.innerHTML = `
            <div class="user">
                ...
                <div
                    style="margin-top: 8px; max-width: 100%; text-align: center; text-overflow: ellipsis; whitespace-nowrap;"
                >
                    <span
                        style="display: block;
                            font-size: 10px;
